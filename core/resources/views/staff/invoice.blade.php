                ...
                <div class="row invoice-info">
                    <div class="col-md-4">
                        ...
                        <address class="font-weight-light">
                            <strong>@lang('Name'): {{__($courierInfo->sender_name)}}</strong><br>
                            @lang('Address'): {{__($courierInfo->sender_address)}}<br>
                    ...
                    <div class="col-md-4">
                        To
                        <address class="font-weight-light">
                            <strong>@lang('Name'): {{__($courierInfo->receiver_name)}}</strong><br>
                            @lang('Address'): {{__($courierInfo->receiver_address)}}<br>
                            <!-- @lang('Phone'): {{__($courierInfo->receiver_phone)}}<br>
                            @lang('Email'): {{__($courierInfo->receiver_email)}} -->
                        </address>
                    </div><!-- /.col -->
                <div class="col-md-4 font-weight-light">
                    <b>@lang('Tracking Id') #{{__($courierInfo->code)}}</b><br>
                    <br>
                    ...
                    <b>@lang('Received At Branch'):</b> {{__($courierInfo->receiverBranch->name)}}<br>___________
                </div>
            </div>
