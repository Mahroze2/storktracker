                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="form-group col-lg-12">
                                                <label for="sender_name" class="form-control-label font-weight-bold">@lang('Store Name')</label>
                                                <input type="text" class="form-control form-control-lg" id="sender_name" name="sender_name" value="{{old('sender_name')}}" placeholder="@lang("Enter Store Name")"  maxlength="40" required="">
                                            </div>

                                             <!-- <div class="form-group col-lg-6">
                                                <label for="sender_phone" class="form-control-label font-weight-bold">@lang('Phone')</label>
                                                <input type="text" class="form-control form-control-lg" id="phone" value="{{old('sender_phone')}}" name="sender_phone" placeholder="@lang("Enter Sender Phone")"  maxlength="40">
                                            </div> -->
                                        </div>
                                        ...
                                        <!-- <div class="row">
                                            <div class="form-group col-lg-12">
                                                ...
                                                <input type="email" class="form-control form-control-lg" id="sender_email" name="sender_email" value="{{old('sender_email')}}" placeholder="@lang("Enter Sender Email")"  maxlength="40">
                                            </div>
                                        </div>  -->

                                        <div class="row">
                                            <div class="form-group col-lg-12">
                                                <label for="sender_address" class="form-control-label font-weight-bold">@lang('Store Address')</label>
                                                <input type="text" class="form-control form-control-lg" id="sender_address" name="sender_address" value="{{old('sender_address')}}" placeholder="@lang("Enter Store Address")"  maxlength="255" required="">
                                            </div>
                                        </div>  
                                    </div> 
                                </div>
                                ...
                                <div class="card border--primary mt-3">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-6">
                                                <label for="receiver_name" class="form-control-label font-weight-bold">@lang('Customer Name')</label>
                                                <input type="text" class="form-control form-control-lg" id="receiver_name" name="receiver_name" value="{{old('receiver_name')}}" placeholder="@lang("Enter Customer Name")"  maxlength="40" required="">
                                            </div>
                                        </div>

                                     <div class="row">
                                            <!--<div class="form-group col-lg-6">-->
                                            <!--    <label for="receiver_phone" class="form-control-label font-weight-bold">@lang('Signed By')</label>-->
                                            <!--    <input type="text" class="form-control form-control-lg" id="receiver_phone" name="receiver_phone" placeholder="@lang("Enter Signed By")" value="{{old('receiver_phone')}}">-->
                                            <!--</div> -->


                                            <!--<div class="form-group col-lg-6">-->
                                            <!--    <label for="receiver_email" class="form-control-label font-weight-bold">@lang('Email')</label>-->
                                            <!--    <input type="email" class="form-control form-control-lg" id="receiver_email" name="receiver_email" value="{{old('receiver_email')}}" placeholder="@lang("Enter Receiver Email")">-->
                                            <!--</div> -->
                                        </div> 

                                        <div class="row">
                                            <div class="form-group col-lg-12">
                                                <label for="receiver_address" class="form-control-label font-weight-bold">@lang('Customer Address')</label>
                                                <input type="text" class="form-control form-control-lg" id="receiver_address" name="receiver_address" placeholder="@lang("Enter Customer Address")" value="{{old('receiver_address')}}"  required="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group mb-md-0 mb-4">
                                                        ...
                                                        <div class="col-md-6 mt-md-0 mt-2">
                                                         ...
                                                         <div class="col-md-3 mt-md-0 mt-2" style="display:none;">
                                                           <div class="input-group mb-3">
