        ...
        <div class="col-xl-4 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--cyan b-radius--10 box-shadow">
                ...
                <div class="details">
                    ...
                    <div class="desciption">
                        <span class="text--small">@lang('Total Managers')</span>
                    </div>
        ...
        <div class="col-xl-4 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--pink b-radius--10 box-shadow ">
                ...
                <div class="details">
                    ...
                    <div class="desciption">
                        <span class="text--small">@lang('Total Trackings')</span>
                    </div>
                            ...
                            @forelse($branchs as $branch)
                                <tr>
                                    ...
                                    <td data-label="@lang('Action')">
                                        <a href="{{route('admin.manager.branch', $branch->id)}}" class="icon-btn btn--primary ml-1">@lang('Managers')</a>
                                        <a href="{{ route('admin.branch.courier.list', $branch->id) }}" class="icon-btn bg--cyan ml-1">@lang('Trackings')</a>
                                        <a href="{{ route('admin.branch.courier.delivery.list', $branch->id) }}" class="icon-btn btn--info ml-1">@lang('Delivered')</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
