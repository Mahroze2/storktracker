        ...
        <div class="container">
            <div class="header-top-wrapper">
                <ul class="header-contact-info">
                    <li>
                        <a href="Mailto:{{__(@$footer->data_values->email)}}"><i class="las la-envelope"></i> customercare@storktrack.com</a>
                    </li>
                    <li>
                        <a href="Tel:{{__(@$footer->data_values->mobile)}}"><i class="las la-phone"></i>1 (833) 291 4413</a>
                    </li>
                </ul>
                ...
                <div class="menu-area align-items-center ">
                    ...
                    <ul class="menu" >
                        ...
                        @foreach($pages as $k => $data)
                            <li id="display" ><a href="{{route('pages',[$data->slug])}}">{{__($data->name)}}</a></li>
                        @endforeach
                    </ul>
                </div>
            </div>
