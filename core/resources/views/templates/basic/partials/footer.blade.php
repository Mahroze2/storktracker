...
<footer class="footer-section bg--title-overlay bg_img bg_fixed" data-background="{{getImage('assets/images/frontend/footer/'. $footer->data_values->background_image, '1920x1080')}}">
            ...
            <div class="row gy-5 justify-content-between">
                ...
                <div class="col-lg-2 col-6">
                    <div class="footer__widget">
                        ...
                        <ul class="useful-link" id="thirdchild">
                            <li>
                ...
                <div class="col-lg-2 col-sm-6">
                    <div class="footer__widget ">
                        <h5 class="title text--white">@lang('Our Policies')</h5>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="footer__widget">
                        ...
                        <ul class="footer__widget-contact">
                            ...
                            <li>
                                <i class="las la-mobile"></i> 1 (833) 291 4413
                            </li>
                            <!-- <li>
                                <i class="las la-fax"></i> @lang('Fax') :  {{__($footer->data_values->fax)}}
                            </li> -->
                            <li>
                                <i class="las la-envelope"></i> customercare@storktrack.com
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="footer-bottom position-relative text-center">
        <div class="container">
            &copy; @lang('All Right Reserved by') <a href="{{route('home')}}">StorkTrack</a>
        </div>
    </div>
</footer>
